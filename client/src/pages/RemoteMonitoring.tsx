...
export default function RemoteMonitoring() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6">
    ...
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-5"><StatCard label="Instances" value={overview.totalInstances} icon="hub" /><StatCard label="Online" value={overview.online} color="text-success" icon="check_circle" /><StatCard label="Offline" value={overview.offline} color="text-error" icon="error" /><StatCard label="Degraded" value={overview.degraded} color="text-warning" icon="warning" /><StatCard label="Active alerts" value={overview.alertCount} color="text-error" icon="notifications_active" /></div>
