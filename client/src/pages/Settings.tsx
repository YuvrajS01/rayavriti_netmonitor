        ...
        <section className="lg:col-span-4 space-y-8">
          <div className="bg-surface-container-low rounded-lg p-8 border border-outline-variant/20">
            ...
            <div className="space-y-4">
              <button onClick={handleLogout} className="w-full py-3 border border-error text-error hover:bg-error hover:text-on-error font-bold rounded-md transition-[background-color,color] text-sm uppercase tracking-wide">
                Sign Out
              </button>
            </div>
          </div>
